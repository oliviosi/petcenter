...
The system SHALL communicate whether the canonical storefront link is active, preview-only, or unavailable based on publication readiness, slug availability, and custom-domain onboarding state.
