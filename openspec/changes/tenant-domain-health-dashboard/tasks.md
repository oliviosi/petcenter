...
- [x] 1. Validar se há migração de banco necessária para suportar os indicadores.
...
- [x] 5. Expor/ajustar contadores de métricas para os eventos de domínio.
- [x] 6. Criar dashboard no Prometheus/Grafana.

## Frontend

- [x] 7. Criar página admin para visão de saúde do domínio.
- [x] 8. Adicionar filtros por tenant e estado.

## CI e Validação

- [x] 9. Adicionar validação em CI para consultas e contrato dos endpoints.
