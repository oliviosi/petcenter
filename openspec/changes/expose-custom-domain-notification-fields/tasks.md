...
- [x] 4. [ci/ops] If migration not applied in environments, document the `dotnet ef database update` steps in runbook and coordinate applying in staging.
- [x] 5. [docs] Update changelog / OpenSpec to reference the fix and verification steps.
